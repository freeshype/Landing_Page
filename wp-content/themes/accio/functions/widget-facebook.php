...
/*---------------------------------------------------------------*/
/* Widget that displays facebook feed
/*----------------------------------------------------------------*/
...
function facebook_like_load_widgets() {
	register_widget('accio_Facebook_LIKE_Widget');
}

// Widget class
class accio_facebook_like_widget extends WP_Widget {

/*-----------------------------------------------------------------------------------*/
/*	Widget Setup
/*-----------------------------------------------------------------------------------*/

function accio_Facebook_LIKE_Widget() {

	// Widget settings
	$widget_ops = array('classname' => 'accio_facebook_like_widget', 'description' => 'Adds support for Facebook Like Box.');

	// Widget control settings
	$control_ops = array('id_base' => 'accio_facebook_like_widget');

	// Create the widget
	$this->WP_Widget('facebook-like-widget', 'Accio: Facebook Like Box', $widget_ops, $control_ops);
...
function form($instance) {
	...
	<p class="description"><?php _e('Enter your facebook page url here, choose your color scheme to show up the like box.', 'framework'); ?></p>

...
if ( ! class_exists( 'RW_Meta_Box' ) )
{
	...
	class RW_Meta_Box
	{
		...
		static function begin_html( $html, $meta, $field )
		{
			...
			return sprintf('<div class="rwmb-label"><label for="%s"><strong>%s</strong><span style="display: block; margin-top: 5px; color: #999999; line-height: 20px;">%s</span></label></div><div class="rwmb-input">',$field['id'],$field['name'], $field['desc']);
		}
